CREATE TABLE Player(Login VARCHAR(50) PRIMARY KEY, Password CHAR(64) NOT NULL, FirstName VARCHAR(255) NOT NULL, LastName VARCHAR(255) NOT NULL, Phone INTEGER), Salt CHAR(20) NOT NULL;
...
CREATE TABLE Event(EventId INTEGER NOt NULL AUTO_INCREMENT, EventName VARCHAR (50), StartDate BIGINT NOT NULL, EndDate BIGINT NOT NULL, TournamentId INTEGER, FOREIGN KEY (TournamentId) REFERENCES Tournament (TournamentId), PRIMARY KEY(EventId));
